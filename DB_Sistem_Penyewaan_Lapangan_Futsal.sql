...
--
-- Host: localhost    Database: sistem_penyewaan_lapangan_futsal
-- ------------------------------------------------------
...
CREATE TABLE `booking` (
  ...
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`id_lapangan`) REFERENCES `lapangan` (`id_lapangan`)
...
INSERT INTO `users` VALUES (1,'admin1','123','admin'),(2,'kasir1','123','kasir'),(3,'customer1','123','customer');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'sistem_penyewaan_lapangan_futsal'
--
...
-- Dump completed on 2026-02-28 13:32:41
